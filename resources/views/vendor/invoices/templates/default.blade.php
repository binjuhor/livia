        ...
        <table class="table table-items">
            <thead>
                <tr>
                    ...
                    @endif
                    <th scope="col" class="text-right border-0 pr-0">{{ __('invoices::invoice.sub_total') }} {{ $invoice->currency_code }}</th>
                </tr>
            </thead>
            <tbody>
                {{-- Items --}}
                ...
                @endif
                    <tr>
                        <td colspan="{{ $invoice->table_columns - 2 }}" class="border-0"></td>
                        <td class="text-right pl-0">{{ __('invoices::invoice.total_amount') }} {{ $invoice->currency_code }}</td>
